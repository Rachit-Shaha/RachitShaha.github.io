...
- **Frameworks and Libraries**: Langchain, Pytorch, Tensorflow, HuggingFace, ChromaDB, TFLearn, OpenCV, Numpy, Pandas, SkLearn, Matplotlib
...
- **Technologies**: Gen AI, RAG, NLP, Distributed Systems, Reinforcement Learning, Model Fine-Tuning, Model Development, Object-Oriented Programming, Computer Vision
...
- Utilised GPT-3.5 model to handle user prompts along with RAG based approch, enhancing user experience and personalization.
...
- Tech Stack: Gen AI, RAG Approach, Langchain, Pinecone, Python, OpenAIStudio, Microsoft Azure Cognitive Services
...
### Gen AI Projects
**1. MCQ Generator Application**
- Developed a Generative AI application using Langchain Framework to generate Multiple-Choice Questions (MCQs) from text or PDF files.
...
**2. Chat With a PDF**
- Developed a Generative AI application using Langchain, OpenAI API, and Pinecone, enabling users to interactively chat with a PDF document.
- The application leverages the GPT-3.5 model and RetrievalQA Chain methodology, employing the RAG approach to provide the GPT model with added context.
- This enhancement facilitates a more intuitive understanding of complex concepts in research papers, textbooks, and legal documents.
- Tech Stack: Python, Langchain, Pinecone, OpenAI API, RAG Approach

### NLP Projects
**1. Evaluation of LLM on Semantic Textual Similarity Datasets**
...
**2. ConvBot: A Virtual Chatterbot**
...
- Tech Stack: Python, NLP, LSTM, Chatbot

### Data Science Projects
**1. Market Basket Analysis of Instacart Data**
...
**1. Evaluation of Classification Algorithms in ML on Synthetic Datasets**
...
**2. Optimizing Vehicle Routing Problem (VRP)**
...
**1. Real-Time Caption Generation for Sign Language**
